    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center"><h1 className="text-2xl font-bold">Users</h1>
                <button className="btn-primary ml-auto" onClick={() => setEdit({ username: '', password: '', full_name: '', email: '', phone_number: '', role: 'admin' })}>
                    ...
                    <tbody>
                        {list.map(u => (
                            <tr key={u.id}>
                                ...
                                <td><span className={`pill ${u.role === 'superadmin' ? 'bg-purple-100 text-purple-700' : 'bg-blue-100 text-blue-700'}`}>{u.role}</span></td>

...
export default function OutsourceDashboard() {
    ...
    const mmCount = rows.filter(r => r.outsource_type === 'Man-Month').length;
    const myCount = rows.filter(r => r.outsource_type === 'Man-Year').length;
    ...
    return (
        <div className="space-y-5">
            <DashboardHeader
                ...
                tiles={[
                    { label: 'Man-Month', value: mmCount, accent: 'blue' },
                    { label: 'Man-Year', value: myCount, accent: 'purple' },

...
async function bootstrap() {
    ...
    const perTenantKeys = ['default_year', 'license_expiring_days', 'footer_text', 'login_log_retention_days', 'kb_version_limit', 'kb_attachment_limit_mb', 'post_it_expiry_days', 'post_it_board_size', 'ai_provider', 'ai_api_key', 'ai_endpoint', 'ai_model', 'announcement_enabled', 'announcement_content'];
    try {
                            ...
                            : key === 'kb_attachment_limit_mb'
                                ...
                                : key === 'post_it_expiry_days'
                                    ...
                                    : key === 'post_it_board_size'
                                        ...
                                        : key === 'ai_provider'
                                            ? 'openai'
                                            : key === 'ai_api_key' || key === 'ai_endpoint' || key === 'ai_model' || key === 'announcement_content'
                                                ? ''

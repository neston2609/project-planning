...
async function bootstrap() {
    ...
    const perTenantKeys = ['default_year', 'license_expiring_days', 'footer_text', 'login_log_retention_days', 'kb_version_limit', 'kb_attachment_limit_mb', 'post_it_expiry_days', 'post_it_board_size', 'ai_provider', 'ai_api_key', 'ai_endpoint', 'ai_model', 'web_search_provider', 'web_search_api_key', 'web_search_endpoint', 'web_search_cx', 'announcement_enabled', 'announcement_content'];
    try {

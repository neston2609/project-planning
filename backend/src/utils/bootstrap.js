                                        ...
                                        : key === 'pipeline_win_threshold_pct'
                                            ...
                                            : key === 'ai_provider'
                                                ...
                                                : key === 'web_search_provider'
                                                    ? 'disabled'
                                                    : key === 'ai_api_key' || key === 'ai_endpoint' || key === 'ai_model' || key === 'web_search_api_key' || key === 'web_search_endpoint' || key === 'web_search_cx' || key === 'announcement_content'
                                                        ? ''
